...
import {createcompany} from '../../Api/createcompservice';
      ...
      <KeyboardAwareScrollView
          ...
          <>
            <View style={styles.gstpan}>
              ...
              <Textinputs
                refe={gstref}
                value={gstno}
                placeholder={appConstant.gstplace}
                onChangeText={text => {
                  !text
                    ? setErrGstno(false)
                    : !reggst.test(text)
          ...
          <>
            <View style={styles.gstpan}>
              ...
              <Textinputs
                refe={panref}
                value={panno}
                placeholder={appConstant.panplace}
                onChangeText={text => {
                  !text
                    ? setErrPanno(false)
                    : !regpan.test(text)
        ...
        <View style={styles.compname}>
          <View
            ...
            <Textinputs
              refe={compref}
              value={comp}
              placeholder={appConstant.complace}
              onChangeText={text => {
                !text
                  ? setErrComp(false)
                  : text.length < 3
        ...
        <View style={styles.compname}>
          <View
            ...
            <View style={styles.phone}>
              ...
              <Textinputs
                refe={phoneref}
                value={number}
                placeholder={appConstant.phoneplace}
                color={colors.black}
                onChangeText={text => {
                  !text
                    ? setErrNumber(false)
          ...
          <View
            ...
            <Textinputs
              refe={addref}
              value={address}
              placeholder={appConstant.addplace}
              color={colors.black}
              onChangeText={text => {
                !text
                  ? setErrAddress(false)
        ...
        <View style={styles.gstpan}>
          ...
          <Textinputs
            refe={addlineref}
            value={addline}
            placeholder={appConstant.addlineplace}
            color={colors.black}
            onChangeText={text => {
              !text
                ? setErrAddline(false)
        ...
        <View style={styles.compname}>
          <View
            ...
            <Textinputs
              refe={localityref}
              value={locality}
              placeholder={appConstant.localityplace}
              onChangeText={text => {
                !text
          ...
          <View
            ...
            <Textinputs
              refe={pincoderef}
              value={pincode}
              placeholder={appConstant.pincodeplace}
              onChangeText={text => {
                !text
                  ? setErrPincode(false)
                  : text.length <= 5
        ...
        <View style={styles.compname}>
          <View
            ...
            <Textinputs
              refe={cityref}
              value={city}
              placeholder={appConstant.cityplace}
              onChangeText={text => {
                !text
                  ? setErrCity(false)
                  : text.length < 3
